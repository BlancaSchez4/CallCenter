...
namespace SoftvMVC.Controllers
{
    ...
    public class ReportesVariosController : BaseController
    {
        ...
        [ValidateInput(false)]
        public ActionResult Reportes_varios_Fechas_2(string cadena)
        {
        ...
        //REportePorPagarTv_2
        [ValidateInput(false)]
        public ActionResult REportePorPagarTv_2(string cadena)
        {
            Document doc = new Document(PageSize.LETTER, 15, 15, 30, 30);
            // Indicamos donde vamos a guardar el documento
            string fileName = Server.MapPath("/Reportes/") + Guid.NewGuid().ToString() + ".pdf";
        ...
        //Por pagar cable
        [ValidateInput(false)]
        public ActionResult ReportePorPagarInternet_2_porPagar(string cadena)
        {
            Document doc = new Document(PageSize.LETTER, 15, 15, 30, 30);
            // Indicamos donde vamos a guardar el documento
            string fileName = Server.MapPath("/Reportes/") + Guid.NewGuid().ToString() + ".pdf";
            ...
            if (reader.HasRows)
            {
                ...
                //if (reader.NextResult()) //direccion
                //{
                //    while (reader.Read())
                //    {
                //        PdfPCell celda = new PdfPCell(new Phrase(reader[1].ToString(), titulo7));
                //        celda.VerticalAlignment = PdfPCell.ALIGN_CENTER;
                //        celda.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
                //        celda.UseVariableBorders = true;
                //        celda.BorderColor = BaseColor.WHITE;
        ...
        //Desconectados cable
        [ValidateInput(false)]
        public ActionResult ReportePorPagarInternet_2_descon(string cadena)
        {
            Document doc = new Document(PageSize.LETTER, 15, 15, 30, 30);
            // Indicamos donde vamos a guardar el documento
            string fileName = Server.MapPath("/Reportes/") + Guid.NewGuid().ToString() + ".pdf";
        ...
        //Por pagar cable
        [ValidateInput(false)]
        public ActionResult REportePorPagarSDP(string cadena)
        {
            Document doc = new Document(PageSize.LETTER, 15, 15, 30, 30);
            // Indicamos donde vamos a guardar el documento
            string fileName = Server.MapPath("/Reportes/") + Guid.NewGuid().ToString() + ".pdf";
        ...
        //ReportePIInt_2
        [ValidateInput(false)]
        public ActionResult ReportePIInt_2(string cadena)
        {
            Document doc = new Document(PageSize.LETTER, 15, 15, 30, 30);
            // Indicamos donde vamos a guardar el documento
            string fileName = Server.MapPath("/Reportes/") + Guid.NewGuid().ToString() + ".pdf";
        ...
        [ValidateInput(false)]
        public ActionResult ReporteNuevoCortesiaTv_2(string cadena)
        {
            // Creamos el documento con el tamaño de página tradicional
            Document doc = new Document(PageSize.LETTER, 15, 15, 30, 30);
        ...
        [ValidateInput(false)]
        public ActionResult ReporteNuevoCortesiaIntDig_2(string cadena)
        {
            // Creamos el documento con el tamaño de página tradicional
        ...
        //ReporteCiudad_2_c
        [ValidateInput(false)]
        public ActionResult ReporteCiudad_2_CU(string cadena)
        {
            // Creamos el documento con el tamaño de página tradicional
            Document doc = new Document(PageSize.LETTER, 15, 15, 30, 30);
        ...
        //ReporteCiudad_2_E
        [ValidateInput(false)]
        public ActionResult ReporteCiudad_2_E(string cadena)
        {
            // Creamos el documento con el tamaño de página tradicional
            Document doc = new Document(PageSize.LETTER, 15, 15, 30, 30);
        ...
        //ReporteCiudad_2
        [ValidateInput(false)]
        public ActionResult ReporteCiudad_2_B(string cadena)
        { //TRES FILTROS
            // Creamos el documento con el tamaño de página tradicional
        ...
        //ReporteCiudad_2
        [ValidateInput(false)]
        public ActionResult ReporteCiudad_2_A(string cadena)
        { //TODOS LOS FILTROS
            // Creamos el documento con el tamaño de página tradicional
        ...
        [ValidateInput(false)]
        public ActionResult ReporteCiudad_2_Internet(string cadena)
        {
            // Creamos el documento con el tamaño de página tradicional
            Document doc = new Document(PageSize.LETTER, 15, 15, 30, 30);
        ...
        [ValidateInput(false)]
        public ActionResult Reporte_Resumen_Por_Colonia(string cadena)
        {
            // Creamos el documento con el tamaño de página tradicional
        ...
        [ValidateInput(false)]
        public ActionResult Reporte_Rango_Fechas_Tv_2(string cadena)
        {
            // Creamos el documento con el tamaño de página tradicional
            Document doc = new Document(PageSize.LETTER, 15, 15, 30, 30);
        ...
        [ValidateInput(false)]
        public ActionResult ReportePIInt_2_Colonias(string cadena)
        { //TRES FILTROS
            // Creamos el documento con el tamaño de página tradicional
            Document doc = new Document(PageSize.LETTER, 12, 12, 30, 30);
        ...
        [ValidateInput(false)]
        public ActionResult Reporte_Rango_Fechas_Tv_2_Colonias(string cadena)
        {
            // Creamos el documento con el tamaño de página tradicional
            Document doc = new Document(PageSize.LETTER, 15, 15, 30, 30);
        ...
        [ValidateInput(false)]
        public ActionResult Reportes_varios_Fechas_2_Colonias(string cadena)
        {
            // Creamos el documento con el tamaño de página tradicional
            Document doc = new Document(PageSize.LETTER, 15, 15, 30, 30);
        ...
        [ValidateInput(false)]
        public ActionResult ReporteCiudad_2_InternetColonias(string cadena)
        {
            // Creamos el documento con el tamaño de página tradicional
            Document doc = new Document(PageSize.LETTER, 15, 15, 30, 30);
        ...
        [ValidateInput(false)]
        public ActionResult ReporteCiudad_2_CU_CableColonias(string cadena)
        {
            // Creamos el documento con el tamaño de página tradicional
            Document doc = new Document(PageSize.LETTER, 15, 15, 30, 30);
        ...
        [ValidateInput(false)]
        public ActionResult ReporteCiudad_2_E_CableColonias(string cadena)
        {
            // Creamos el documento con el tamaño de página tradicional
            Document doc = new Document(PageSize.LETTER, 15, 15, 30, 30);
        ...
        [ValidateInput(false)]
        public ActionResult ReporteCiudad_2_Baja_CableColonias(string cadena)
        {
            // Creamos el documento con el tamaño de página tradicional
            Document doc = new Document(PageSize.LETTER, 15, 15, 30, 30);
